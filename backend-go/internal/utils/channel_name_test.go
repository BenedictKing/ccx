...
func TestDeriveChannelNameFromBaseURL(t *testing.T) {
	cases := []struct {
		...
		{"openai 官方", "https://api.openai.com/v1", "openai"},
		{"去 www 前缀", "https://www.example.com/v1", "example"},
		{"多段公共后缀", "https://api.bigmodel.cn/v1", "bigmodel"},
		{"多级子域名剥前缀", "https://gateway.api.deepseek.com/v1", "deepseek"},
		{"带端口", "https://api.example.com:8443/v1", "example-8443"},
