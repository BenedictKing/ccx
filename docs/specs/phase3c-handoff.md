...
> **⚠️ 历史快照（2026-08-11），不再是活文档。** 本文档的全部待办（波 1 重做、波 3 落地、任务 8 CapabilityProbeLedger 接入 healthcheck、任务 9 env 登记）均已在 2026-08-11 当天完成，§5 固化的 git status 与 §6-§9 的状态描述均已过时，**请勿据此判断当前实现**。现状以 `channel-data-model-v2.md` §6/§7 为准。
